...
-- insert into books (title, publishing_year, genre_id) values ('There Are Rivers in the Sky', 2024, (select id from genres where name = 'historical fiction'));
-- insert into books (title, publishing_year, genre_id) values ('Kaikeyi', 2022, (select id from genres where name = 'historical fiction'));
